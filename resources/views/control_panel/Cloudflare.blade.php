                                    ...
                                    <form method="POST" action="{{ route('Cloudflare.store') }}">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group pb-4">
                                                ...
                                                <input type="text" class="form-control" name="domain_name" id="exampleInputEmail1"
                                                    placeholder="Domain" />
                                            </div>
                                            <div class="col-md-12 row pb-4">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tunel_name" id="exampleInputPassword1"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tunel_host" id="exampleInputPassword1"
                                            ...
                                            <div class="col-md-12 row pb-4">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tunel_type" id="exampleInputPassword1"
                                                        placeholder="e.g SSH" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tunel_login_users" id="exampleInputPassword1"
                                            ...
                                            <div class="col-md-12 row pb-4">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="password" class="form-control"
                                                        id="exampleInputPassword1" name="tunel_login_password" placeholder="Password" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="exampleInputPassword1" class="float-start pb-2">
                                                        Login Key
                                                    </label>
                                                    <input type="text" class="form-control" name="tunel_login_key" id="exampleInputPassword1"
