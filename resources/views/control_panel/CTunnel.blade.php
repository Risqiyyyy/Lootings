...
<div>
	...
	<div id="app" class="app app-header-fixed app-sidebar-fixed ">
        ...
        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Domain" />
    </div>
    <div class="col-md-12 row pb-4">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Tunnel Name" />
        </div>
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="float-start pb-2">
                Tunnel Host
            </label>
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Tunnel Host" />
        </div>
    </div>
    <div class="col-md-12 row pb-4">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="e.g SSH" />
        </div>
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="float-start pb-2">
                Login Username
    ...
    <div class="col-md-12 row pb-4">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Login Key" />
        </div>
    </div>
...
<div class="col-md-12 row pb-4">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Alt. Username" />
    </div>
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Alt. Password" />
    </div>
</div>
<div class="col-md-12 row pb-4">
    <div class="form-group col-md-12">
        ...
        <textarea type="text" class="form-control " id="exampleInputPassword1" placeholder="More Information"
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> <form action="" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success" data-confirm-delete="true">Details</button>
                                    </form></td>
                                </tr>
